...
class Dashboard extends Component {
      ...
      <Card hoverable style={{ maxHeight: 230, minHeight: 230 }}>
        <div className="statsWithProgressBar">
          <div className="header">
            <span className="headerNum">
              <CountUp end={3201} />
            </span>{" "}
            <span className="statsHeaderTitle">Progress</span>
          </div>
      ...
      <Card hoverable style={{ maxHeight: 230, minHeight: 230 }}>
        <div className="userStats-circular-progress">
          <div className="userStats-card-header">
            ...
            <div className="card-header-label">User daily use</div>
          </div>
  ...
  static CircularProgressCardWithHeader = ({
    title,
    count,
    strokeColor,
    progress,
  ...
  static StatsWithTimeline = ({ timelineData }) => {
    return (
      <Row
        gutter={24}
        style={{ margin: 1, marginTop: 30, paddingBottom: "3rem" }}
      >
        <Dashboard.CircularProgressCardWithHeader
          title="Total Projects"
          count={3200}
          progress={80}
          strokeColor="6bdcff"
          headerBackground="#6bdcff"
        />
        <Dashboard.CircularProgressCardWithHeader
          title="Total Projects"
          count={900}
        ...
        <Dashboard.CircularProgressCardWithHeader
          ...
          progress={60}
          strokeColor="ffc920b3"
          headerBackground="#ffc920b3"
        />
        <Col span={9} style={{ padding: 0 }}>
          <Dashboard.TimeLineComponent
            headerBackground="#ff6066"
